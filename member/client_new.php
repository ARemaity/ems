																	...
																	<div class="col-xl-9">
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" name="address" type="text"  required>
																				<div class="fv-plugins-message-container"></div></div>
																			</div>
																			<!--end::Group-->
																			<!--begin::Group-->
																		...
																		<div class="d-flex justify-content-between border-top pt-10 mt-15">
																			...
																			<div>
																				...
																				<button type="submit" name ="submit" id="next-step" class="btn btn-primary font-weight-bolder px-9 py-4">Add Client</button>
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
						...
						<div class="overlay-layer">
							<a href="../../../../demo1/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo1/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo2/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo2/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo3/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo3/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo4/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo4/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo5/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo5/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo6/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo6/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo7/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo7/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo8/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo8/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo9/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo9/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo10/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo10/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo11/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo11/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo12/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo12/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="../../../../demo13/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../demo13/rtl/custom/apps/projects/view-project.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>

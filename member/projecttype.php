                       ...
                       <div class="container-fluid d-flex align-items-stretch justify-content-between">
                           <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                               ...
                               <div class="d-flex align-items-center flex-wrap mr-2">
                                   <!--begin::Title-->
                                   <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Project Type</h5>
                                   <!--end::Title-->
                                   <!--begin::Separator-->
                           ...
                           <div
                               ...
                               <div class="d-flex align-items-center flex-wrap mr-2">
                                   ...
                                   <a href="javascript:;" id="nexpense"
                                       class="btn btn-light-primary font-weight-bolder btn-sm">Add Type</a>
                                   <!--end::Action-->
                               </div>
                               <!--end::Info-->
                               <!--begin::Toolbar-->
...
<i aria-hidden="true" class="ki ki-close"></i>
       ...
       <script src="assets/js/scripts.bundle.js"></script>
       <script src="assets/js/pages/projecttype.js"></script>





       <?php     require_once("layout/typemodal.php")       ?>

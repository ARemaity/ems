...
function mbselect(elm) {
  ...
  typer.type = 'text';
  typer.setAttribute('class', 'typer form-control');
  typer.setAttribute('autocomplete', 'off');
  typer.className = 'typer form-control';
  ...
  typer.onkeyup = function (event) {
    if (event.which != 13 && event.which != 16 && event.which != 17 && event.which != 18 && event.which != 19 && event.which != 20 && event.which != 27 && event.which != 35 && event.which != 36 && event.which != 37 && event.which != 38 && event.which != 39 && event.which != 40 && event.which != 91 && event.which != 93 && event.which != 224 && event.which != 16 && event.which != 9) {
